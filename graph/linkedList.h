...
/**
  ...
  @note       The traversal is cycle-invariant, so the offset *may*
              exceed the number of physical nodes, providing they link
              cyclically
*/
...
/**
  ...
  @note       Copying will not copy the linked list's node's contents,
              but references will be preserved
  @note       Copying will have the effect of defragmenting a linked
              list that has had any structural modifications
*/
...
/**
  ...
  @note       If you delete the starting node, the pointer to the
              starting node will be updated appropriately
  @note       The nodes' contents will not be freed
*/
